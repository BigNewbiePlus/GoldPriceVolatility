...
def create_base_estimators(modelnumber, kernel, class_weight):
    estimators = []
...
def train_model(pos_datas, neg_datas, traindatarate, modelpath, modelnumber, C, kernel, shrinking, probability, tol, class_weight, verbose, max_iter):
    ...
    estimators = create_base_estimators(modelnumber, kernel, class_weight) 
...
if __name__ == '__main__':
    ...
    parser.add_argument("-modelname", default="svc_unbalance_voting.model", help="the model path, save for train and use for test!")
    parser.add_argument("-modelnumber", default=15, type=int, help="the model path, save for train and use for test!")
